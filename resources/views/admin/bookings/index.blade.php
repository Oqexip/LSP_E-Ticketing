    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        ...
        <div class="glass-card p-5">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-accent-400">Rp {{ number_format($bookings->sum('total_price')) }}</p>
        ...
        <div class="glass-card p-5">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900">{{ $bookings->sum('total_seats') }}</p>
                    ...
                    <tbody>
                        @foreach ($bookings as $b)
                            <tr>
                                ...
                                <td class="font-medium text-accent-400">Rp {{ number_format($b->total_price) }}</td>
                                <td>
                                    @if($b->status === 'Lunas')
