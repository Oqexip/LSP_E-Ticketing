        ...
        <div class="glass-card p-8 animate-fade-in-up">
            ...
            <form action="/admin/schedules/store" method="POST" class="space-y-5">
                ...
                <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="btn-gradient-green inline-flex items-center gap-2 text-white font-semibold py-2.5 px-6 rounded-xl border-none cursor-pointer transition-all duration-300">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
