        ...
        <div class="glass-card p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-accent-500 mt-1">Rp {{ number_format($bookings->sum('total_price')) }}</p>
                </div>
        ...
        <div class="glass-card p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1">{{ $bookings->sum('total_seats') }}</p>
                </div>
                    ...
                    <tbody>
                        @foreach ($schedules as $s)
                            <tr>
                                ...
                                <td class="font-medium text-accent-500">Rp {{ number_format($s->price) }}</td>
                                <td>
                                    @if($s->stock > 20)
                    ...
                    <tbody>
                        @foreach ($bookings as $b)
                            <tr>
                                ...
                                <td class="font-medium text-accent-500">Rp {{ number_format($b->total_price) }}</td>
                                <td>
                                    @if($b->status === 'Lunas')
